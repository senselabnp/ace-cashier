        ...
        <div class="row mt-40">
            ...
            <div class="col-md-4 mt-40 pd-60">
                ...
                <div class="text-center">
                    <img width="60%" src="{{ \Ace\Cashier\Cashier::public_url('/vendor/Ace-cashier/image/paypal-logo.png') }}" />
                </div>
            </div>
            <div class="col-md-4 mt-40 pd-60">            
                ...
                <script>
                    $(function() {
                        ...
                        var form = jQuery('<form>', {
                            'action': '{{ \Ace\Cashier\Cashier::lr_action('\Ace\Cashier\Controllers\PaypalController@checkout', [
