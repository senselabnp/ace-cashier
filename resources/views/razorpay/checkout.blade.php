    ...
    <body>
        <div class="main-container row mt-40">
            ...
            <div class="col-md-4 mt-40 pd-60">
                ...
                <img class="rounded" width="100%" src="{{ \Ace\Cashier\Cashier::public_url('/vendor/Ace-cashier/image/razorpay.png') }}" />
            </div>
            <div class="col-md-4 mt-40 pd-60">                
                ...
                <div class="hide" style="display:none">
                    <form action="{{ \Ace\Cashier\Cashier::lr_action('\Ace\Cashier\Controllers\RazorpayController@checkout', [
                    '_token' => csrf_token(),
                    'invoice_uid' => $invoice->uid,
                        ...
                        <script
                            ...
                            {{-- data-image="{{ \Ace\Model\Setting::get('site_logo_small') ? \Ace\Cashier\Cashier::lr_action('SettingController@file', \Ace\Model\Setting::get('site_logo_small')) : URL::asset('images/default_site_logo_small_' . (Auth::user()->customer->getColorScheme() == "white" ? "dark" : "light") . '.png') }}" --}}
