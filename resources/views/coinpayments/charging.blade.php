    ...
    <body>
        ...
        <div class="row">
            ...
            <div class="col-md-8 text-center" style="margin-top: 30vh">
                <div class="mb-40">
                    <img src="{{ \Ace\Cashier\Cashier::public_url('images/loading.gif') }}" />
                </div>
                ...
                <div class="sub-section">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form id="pay_now" method="POST" action="{{ \Ace\Cashier\Cashier::lr_action('\Ace\Cashier\Controllers\CoinpaymentsController@checkout', [
