<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="{{ \Ace\Cashier\Cashier::public_url('/vendor/Ace-cashier/css/main.css') }}">
    </head>
    ...
    <body>
        <div class="main-container row mt-40">
            ...
            <div class="col-md-4 mt-40 pd-60">
                ...
                <img class="rounded" width="100%" src="{{ \Ace\Cashier\Cashier::public_url('/vendor/Ace-cashier/image/stripe.png') }}" />
            </div>
            <div class="col-md-4 mt-40 pd-60">
                ...
                <div class="sub-section">
                    @if ($cardInfo !== NULL)
                        ...
                        <form id="stripe_button"
                            action="{{ \Ace\Cashier\Cashier::lr_action('\Ace\Cashier\Controllers\StripeController@autoBillingDataUpdate') }}" method="POST">
                            {{ csrf_field() }}
                ...
                <form id="stripe_button" style="display:none"
                    action="{{ \Ace\Cashier\Cashier::lr_action('\Ace\Cashier\Controllers\StripeController@autoBillingDataUpdate', [
                    '_token' => csrf_token(),
                ]) }}" method="POST">
                ...
                <a
                    href="{{ \Ace\Cashier\Cashier::lr_action('AccountSubscriptionController@index') }}"
