    ...
    <body>
        <div class="main-container row mt-40">
            ...
            <div class="col-md-4 mt-40 pd-60">
                ...
                <img class="rounded" width="100%" src="{{ \Ace\Cashier\Cashier::public_url('/vendor/Ace-cashier/image/braintree.png') }}" />
            </div>
            <div class="col-md-4 mt-40 pd-60">
                ...
                @if ($cardInfo !== NULL)
                    <div class="sub-section mb-5">
                        ...
                        <form
                            action="{{ \Ace\Cashier\Cashier::lr_action('\Ace\Cashier\Controllers\BraintreeController@autoBillingDataUpdate') }}" method="POST">
                            {{ csrf_field() }}
