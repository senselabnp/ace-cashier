    ...
    <body>
        <div class="main-container row mt-40">
            ...
            <div class="col-md-4 mt-40 pd-60">
                ...
                <img class="rounded" width="100%" src="{{ \Ace\Cashier\Cashier::public_url('/vendor/Ace-cashier/image/paystack.svg') }}" />
            </div>
            <div class="col-md-4 mt-40 pd-60">
                <form id="paymentForm">
                ...
                <form id="checkoutForm" method="GET" action="{{ \Ace\Cashier\Cashier::lr_action('\Ace\Cashier\Controllers\PaystackController@paymentRedirect') }}">
